...
|:---|:------------------|:--------|
| 1 | Write a function that returns true if a string is a palindrome | ✅ Completed |
...
| 6 | Check if two strings are anagrams | ✅ Completed |
...
| Day | Task Description | Status |
|:---|:------------------|:--------|
| 81 | Implement a simple calculator | ⬜ Not started |
| 82 | Implement a command-line todo list | ⬜ Not started |
| 83 | Create a program that fetches mock data (no network; simulate) | ⬜ Not started |
| 84 | Simulate a deck of cards and draw hands | ⬜ Not started |
| 85 | Implement tic-tac-toe logic (no UI) | ⬜ Not started |
| 86 | Count occurrences of words across multiple files | ⬜ Not started |
| 87 | Implement a basic stopwatch/timer class | ⬜ Not started |
| 88 | Validate passwords according to rules | ⬜ Not started |
| 89 | Simulate rolling dice N times and collect stats | ⬜ Not started |
| 90 | Implement a simple logger class | ⬜ Not started |
| 91 | Simulate bank account transactions | ⬜ Not started |
| 92 | Implement a simple caching mechanism | ⬜ Not started |
| 93 | Create a miniature template engine | ⬜ Not started |
| 94 | Implement a basic dependency graph topological sort | ⬜ Not started |
| 95 | Simulate a job scheduler with a queue | ⬜ Not started |
| 96 | Implement a basic pub/sub event system | ⬜ Not started |
| 97 | Implement a configuration loader supporting multiple formats | ⬜ Not started |
| 98 | Create a small math expression parser | ⬜ Not started |
| 99 | Implement a rate limiter | ⬜ Not started |
| 100 | Build a tiny REPL loop in each language | ⬜ Not started |
